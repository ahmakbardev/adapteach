  ...
  return (
    <main className="flex pt-4 flex-col">
      <div className="flex px-28 2xl:px-48 min-h-screen items-center justify-between">
        ...
        <div
          id="header"
          className="relative basis-2/5 w-1/2 flex justify-end object-contain"
        >
          {/* <Image
              alt="Logo"
              src="/img1.png"
          ...
          {/* <img
            src="/img2.png"
            className="absolute w-3/4 -left-28 -bottom-36 object-contain rounded-xl"
            alt=""
          /> */}
          <Image
            data-aos="fade-up"
        ...
        <div className="flex flex-wrap my-10 justify-center gap-3 items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-sm">
              AdapTeach mengembangkan teknologi AI yang canggih untuk memberikan
              solusi yang cerdas dan inovatif untuk mendukung pembelajaran di
              Indonesia.
            </p>
          </div>
          <div
          ...
          >
            <img
              ...
              className="w-12 h-12 rounded-full bg-white"
            />
            <h1 className="text-xl mt-4 mb-2">Efisiensi Produktifitas Guru</h1>
            <p className="text-gray-400 text-sm">
              AdapTeach dirancang khusus untuk membantu tugas-tugas guru. Dengan
              fitur canggih guru dapat menghemat waktu dan fokus pada hal-hal
          ...
          >
            <img
              ...
              className="w-12 h-12 rounded-full bg-white"
            />
            <h1 className="text-xl mt-4 mb-2">Pembelajaran Lebih Optimal</h1>
            <p className="text-gray-400 text-sm">
              Setiap siswa memiliki kebutuhan pembelajaran yang unik. AdapTeach
              memberikan pendekatan personalisasi kepada siswa sehingga
          ...
          >
            <img
              ...
              className="w-12 h-12 rounded-full bg-white"
            />
            <h1 className="text-xl mt-4 mb-2 truncate">
              Pengembangan Kemampuan Berfikir Kritis
            </h1>
            <p className="text-gray-400 text-sm">
              AdapTeach mendorong kemampuan berfikir kritis melalui fitur ide
              pembelajaran. Dengan merangsang pemikiran kritis, dapat membantu
          ...
          >
            ...
            />
            <h1 className="text-xl mt-4 mb-2">
              Dukungan Teknologi untuk Kurikulum Merdeka
            </h1>
            <p className="text-gray-400 text-sm">
              Dengan fitur adaptif dan analisis yang mendalam, kami membantu
              mewujudkan visi kurikulum yang fleksible dan memberdayakan setiap
              siswa.
            </p>
          </div>
        </div>
      </div>
      <div id="cara" className="flex px-28 2xl:px-48 flex-col pt-36">
        <div className="text-center">
          <h1 className="text-primary my-3 font-bold">Cara Kerja</h1>
          <h1 className="text-3xl font-semibold">Cara Kerja Fitur Kami</h1>
        </div>
        <div className="flex my-10">
          <div className="flex justify-around gap-10">
            <div className="flex relative flex-col justify-center items-center py-3 px-9 text-center">
              <div className="w-10 h-10 bg-gray-400 rounded-full absolute left-10 top-5"></div>
              <div className="w-44 h-44 bg-gray-400 rounded-full"></div>
              <h1 className="text-2xl mt-5">Pembuatan RPP yang Efisien</h1>
              <p className="text-sm text-gray-500">
                AdapTeach menyediakan alat pintar untuk membuat Rencana
                Pembelajaran Harian (RPP) dengan mudah dan efisien.
              </p>
            </div>
            <div className="flex relative flex-col justify-center items-center py-3 px-9 text-center">
              <div className="w-10 h-10 bg-gray-400 rounded-full absolute left-10 top-5"></div>
      ...
      <div className="flex px-28 2xl:px-48 flex-col py-20">
        <div className="text-center">
          <h1 className="text-primary my-3 font-bold">Partner</h1>
          <h1 className="text-3xl font-semibold">Bisnis Partner Kami</h1>
        </div>
        <section className="">
          <div className="py-8 lg:py-6 mx-auto max-w-screen-xl px-4">
            <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
              <a href="#" className="flex justify-center items-center">
                <svg
                  className="h-9 hover:text-black transition-all duration-200 ease-in-out"
                  viewBox="0 0 125 35"
                  fill="currentColor"
              ...
              <a href="#" className="flex justify-center items-center">
                <svg
                  className="h-8 hover:text-black transition-all duration-200 ease-in-out"
                  viewBox="0 0 151 34"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <a href="#" className="flex justify-center items-center">
                <svg
                  className="h-6 hover:text-black transition-all duration-200 ease-in-out"
                  viewBox="0 0 124 21"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div data-aos="fade-up" data-aos-delay="100" data-aos-anchor-placement="center-bottom" className="flex-shrink-0 m-6 w-72 group/raihan group/span relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-2xl">
            <div className="relative flex items-center justify-center">
              <img
                ...
                alt=""
              />
              <div className="absolute group-hover/raihan:bottom-0 -bottom-20 transition-all ease-in-out duration-150 text-white bg-primary/75 w-full px-6 py-4">
                <span className="block opacity-75 -mb-1">Co Founder</span>
                <div className="flex justify-between">
                  <span className="block font-semibold text-2xl">Zaka</span>
                  <div className="flex gap-2 relative">
                    <a
                      href="#"
                      target="_blank"
                      className="relative top-12 group-hover/span:top-0 transition-all ease-in-out duration-300 delay-100 bg-white rounded-full text-black text-xs font-bold px-2 py-2 leading-none  hover:scale-110"
                    >
                    ...
                    <a
                      href="#"
                      target="_blank"
                      className="relative top-12 group-hover/span:top-0 transition-all ease-in-out duration-300 delay-150 bg-white rounded-full text-black text-xs font-bold px-2 py-2 leading-none  hover:scale-110"
                    >
                    ...
                    <a
                      href="#"
                      target="_blank"
                      className="relative top-12 group-hover/span:top-0 transition-all ease-in-out duration-300 delay-200 bg-white rounded-full text-black text-xs font-bold px-2 py-2 leading-none  hover:scale-110"
                    >
          ...
          <div data-aos="fade-up" data-aos-delay="200" data-aos-anchor-placement="center-bottom" className="flex-shrink-0 m-6 w-72 group/raihan group/span relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-2xl">
            <div className="relative flex items-center justify-center">
              <img
                ...
                alt=""
              />
              <div className="absolute group-hover/raihan:bottom-0 -bottom-20 transition-all ease-in-out duration-150 text-white bg-teal-600/75 w-full px-6 py-4">
                <span className="block opacity-75 -mb-1">Founder</span>
                <div className="flex justify-between">
                  <span className="block font-semibold text-2xl">Raihan</span>
                  <div className="flex gap-2 relative">
                    <a
                      href="#"
                      target="_blank"
          ...
          <div data-aos="fade-up" data-aos-delay="300" data-aos-anchor-placement="center-bottom" className="flex-shrink-0 m-6 w-72 group/raihan group/span relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-2xl">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute group-hover/raihan:bottom-0 -bottom-20 transition-all ease-in-out duration-150 text-white bg-primary/75 w-full px-6 py-4">
                <span className="block opacity-75 -mb-1">Co Founder</span>
                <div className="flex justify-between">
                  <span className="block font-semibold text-2xl">Ailsa</span>
                  <div className="flex gap-2 relative">
                    <a
                      href="#"
                      target="_blank"
        ...
        <div data-aos="fade-up" data-aos-delay="200" data-aos-anchor-placement="top-bottom" className="flex items-center justify-center">
          <div className="flex-shrink-0 m-6 w-72 group/raihan group/span relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-2xl">
            <div className="relative flex items-center justify-center">
              <img
                className="relative w-full object-cover"
                src="/akbar-profile.png"
                alt=""
              />
              <div className="absolute group-hover/raihan:bottom-0 -bottom-20 transition-all ease-in-out duration-150 text-white bg-primary/75 w-full px-6 py-4">
                <span className="block opacity-75 -mb-1">Co Founder</span>
                <div className="flex justify-between">
                  <span className="block font-semibold text-2xl">Akbar</span>
                  <div className="flex gap-2 relative">
                    <a
                      href="#"
                      target="_blank"
          ...
          <div data-aos="fade-up" data-aos-delay="300" data-aos-anchor-placement="top-bottom" className="flex-shrink-0 m-6 w-72 group/raihan group/span relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-2xl">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute group-hover/raihan:bottom-0 -bottom-20 transition-all ease-in-out duration-150 text-white bg-primary/75 w-full px-6 py-4">
                <span className="block opacity-75 -mb-1">Co Founder</span>
                <div className="flex justify-between">
                  <span className="block font-semibold text-2xl">Annisa</span>
                  <div className="flex gap-2 relative">
                    <a
                      href="#"
                      target="_blank"
      ...
      <div className="flex px-28 2xl:px-48 flex-col py-10 bg-custom-dark text-white">
        <div className="flex flex-col">
          <h1 className="text-gray-400 my-3">CONTACT US</h1>
          <div className="flex justify-between gap-10 pb-10 border-b-2">
            <div className="basis-1/2">
              <h1 className="text-7xl">Tertarik mencoba fitur kami?</h1>
            </div>
            <div className="basis-1/2">
              <h4 className="mb-4">Lets Contact Us</h4>
                ...
                <div className="flex gap-8">
                  <div className="flex-1 w-full">
                    <input
                      ...
                      name="name"
                      className="py-3 border-b-2 bg-transparent border-gray-500 w-full focus:outline-none"
                    />
                  </div>
                  <div className="flex-1 w-full">
                    <input
          ...
          <div className="flex gap-14 justify-between py-10 border-b-2">
            <div className="flex gap-2">
              ...
              <div className="flex-none px-4">
                <h4 className="text-gray-400">INSTAGRAM</h4>
                <p className="text-base">@adapteach.ai</p>
              </div>
            </div>
          ...
          <p className="mt-5">&copy; 2023 - all rights reserved.</p>
        </div>
      </div>
    </main>
  );
